...
<head>
    ...
    <style>
        ...
        .navbar-vertical { position: fixed; height: 100%; width: 250px; background-color: #343a40; }
        #page-content { margin-left: 250px; padding: 20px; }
    </style>
</head>
<body>
<nav class="navbar-vertical navbar" style="color: white">
    <%
    ...
    <div class="vh-100" data-simplebar>
        ...
        <a class="navbar-brand" href="HomeServlet">
            <img src="${pageContext.request.contextPath}/assets/logoiit.png" class="logo-img" alt="Geeks" />
        </a>
        <!-- Navbar nav -->
                ...
                <div class="d-flex align-items-center">
                    ...
                    <ul class="nav col-12 col-lg-auto mb-2 mb-lg-0 ms-3">
                        <li class="nav-item">
                            ...
                            %>
                            <span class="nav-link text-black"><%= user.getEmail() %></span>
                        </li>
                    </ul>
                </div>
                <div class="d-flex align-items-center">
                                ...
                                <div class="mt-4">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="mb-3 col-md-12">
                                            ...
                                            <%--@declare id="posttitle"--%><label for="postTitle" class="form-label">Nom du groupe</label>
                                        ...
                                        <!-- Excerpt -->
                                        <div class="mb-3 col-md-12">
                                            <%--@declare id="excerpt"--%><label for="Excerpt" class="form-label">Nombre d etudiant</label>
