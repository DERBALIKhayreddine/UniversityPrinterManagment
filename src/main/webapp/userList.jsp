                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-between">
                                                <a class="dropdown-item p-0" href="AdminServlet?action=edit&userId=${user.userId}" style="flex: 1;">
                                                    <button class="btn btn-warning w-100">Modifier</button>
                                                </a>
                                                <a class="dropdown-item p-0" href="#" onclick="openDeleteConfirmationModal(${user.userId})" style="flex: 1; margin-left: 5px;">
