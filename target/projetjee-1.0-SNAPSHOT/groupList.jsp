                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-between">
                                                                    <a class="dropdown-item" href="Group?action=edit&id=${group.id}" style="flex: 1;">
                                                                        <button class="btn btn-warning w-100">Modifier</button>
                                                                    </a>

                                                                    <a class="dropdown-item" href="#" onclick="openDeleteConfirmation(${group.id})" style="flex: 1; margin-left: 5px;">
