                                    ...
                                    <c:forEach items="${roles}" var="role">
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-between">
                                                <a class="dropdown-item p-0" href="RoleServlet?action=edit&roleId=${role.id}"  style="flex: 1;">
                                                    <button class="btn btn-warning w-100">Modifier</button>
                                                </a>
                                                <a class="dropdown-item p-0" href="#" onclick="openDeleteConfirmation(${role.id})" style="flex: 1; margin-left: 5px;">
